      ...
      <main className="main-content">
        <div className="page">
          <div className="form-container">
            <h2>{editId ? "Edit" : "Add"} GST Registration</h2>
            <form id="gstRegistrationForm" onSubmit={handleSubmit}>
              ...
              <div className="button-group">
                ...
                <button type="submit" disabled={!agreed} style={{ opacity: agreed ? 1 : 0.6, cursor: agreed ? "pointer" : "not-allowed" }}>{editId ? "Update & Resubmit" : "Save"}</button>
              </div>
            </form>
          </div>
        </div>
